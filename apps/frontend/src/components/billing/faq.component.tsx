  ...
  return [
      ...
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Publica' : 'Gitroom'}?`
      ),
      description: t(
        ...
        `${
          ...
          isGeneral ? 'Publica' : 'Gitroom'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/gitroomhq/publica-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
