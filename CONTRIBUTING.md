...
- **[Discord chat](https://discord.publica.do)**: To chat with people [Discord chat](https://discord.publica.do/) and a quicker feedback.
...
Again, do check the [developer guide](https://docs.publica.do/developer-guide). Much of what you probably need to know is in there.

If you encounter any issues, please visit our [support page](https://docs.publica.do/support) or check the community forums. Your contributions help make Postiz better!
